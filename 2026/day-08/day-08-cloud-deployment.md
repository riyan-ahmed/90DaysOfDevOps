...
Command : `ssh -i "linux-for-devops.pem" ubuntu@ec2-35-172-192-73.compute-1.amazonaws.com`
...
Command : `scp -i ssh -i "linux-for-devops.pem" ubuntu@ec2-35-172-192-73.compute-1.amazonaws.com:/var/log/nginx/access.log .`
    
`scp -i ssh -i "linux-for-devops.pem" ubuntu@ec2-35-172-192-73.compute-1.amazonaws.com:~/journalctl.log .`
